...
#             elevation = 1.354999999999993
#
#         start_flag = False
#         deflection1 = []
#         # windspeed = SimulatedConditions.windspeed()
#         # winddir = SimulatedConditions.winddir()
#         windspeed = 10
#         winddir = 90
...
def BulletPhysicsWind(size, range1, iteration, position, bullet, atmosphere,f2, scale): # atmosphere[crosswind, direction, elevation, windage, density]
    target_size =  size / 12
...
def BulletPhysicsGravity(size, range1, iteration, position, bullet, atmosphere, f2, scale):
    target_size = size / 12
    drop, deflection, speed = Ballistics.trajectoryGraph(bullet,atmosphere)  # -(wind_vect * (((test_time) - (range1 / speed)))) #deflection goes in the opposite direction of the wind direction
