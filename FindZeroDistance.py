...
def Grapher(bullet, atmosphere):
	...
	elevation_angle = math.radians(deg) / float(1000)
	...
	# print(t, ': ', (1.0936*dist_x_instant_updated), 'orig', (dist_z_instant_orig*39.3701), " new: ", (1.0936*dist_x_instant_updated) * ((bullet[6]) / 100))
